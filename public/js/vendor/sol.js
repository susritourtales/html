(function ($, window, document) {
    ...
    SearchableOptionList.prototype = {
        ...
        _initializeUiElements: function () {
            ...
            this.$container = $('<div class="sol-container position-relative"/>')
                .hide()
        ...
        _renderOption: function (solOption, $optionalTargetContainer) {
            var self = this,
                ...
                $inputElement,
                $labelText = $('<div class="sol-label-text text-capitalize"/>')
            ...
            if (this.config.multiple) {
                // use checkboxes
                $inputElement = $('<input type="checkbox" class="sol-checkbox"/> <span class="checkmark"></span>');
            ...
            $label = $('<label class="sol-label checkbox-custom position-relative mb-0 pointer "/>')
        ...
        _selectionChange: function ($changeItem, skipCallback) {
            ...
            if (this.config.maxShow != 0 && selected.length > this.config.maxShow) {
                ...
                this.$xItemsSelected.html('<div class="sol-selected-display-item-text text-capitalize">' + xitemstext + '<div>');
        ...
        _addSelectionDisplayItem: function ($changedItem) {
            ...
            if (!$existingDisplayItem) {
                $displayItemText = $('<span class="sol-selected-display-item-text text-capitalize" />').html(solOptionItem.label);
    ...
    $.fn.distory=function()
    {
        window.SearchableOptionList=null;
    }
