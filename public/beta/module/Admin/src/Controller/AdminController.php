            ...
            if(!$chkTourists){
                ...
                if($sttUserId){
                    ...
                    if($role != \Admin\Model\User::Individual_role){
                        ...
                        $sds_ed_dt = date_create($sds_ed);
                        $diff = date_diff($sds_ed_dt, $sed);
                        return new JsonModel(array('success'=>false,'message'=>"($sds_ed) - ($sed_str) = " . strval($diff)));
                ...
                if($tc){
                    ...
                    if($response){
                        ...
                        $stxt = $taName .' has sponsored your subscription for &lsquo;Susri Tour Tales&rsquo;. Please install the app from android play store.';
