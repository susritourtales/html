...
$(document).ready(function () {
        ...
        if(items>10) {
            $('.pagination').pagination({
                ...
                onPageClick: function (pageNumber) {
                    ...
                    ajaxCall = $.ajax({
                        type: "POST",
                        url: BASE_URL + '/admin/add-free-tour-list',
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
    ...
    initPagination();
    $("body").on('change', '.freeCb',  function (){
        var isChecked = $(this).prop('checked');
        var taleId = $(this).attr("data-id");
        postData("/admin/add-free-tour-list", {tale_id:taleId,edit:'1',free:isChecked,},function (response){
