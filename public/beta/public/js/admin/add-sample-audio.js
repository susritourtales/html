...
$(document).ready(function ()
{
    $("body").on("change","#country",function(){
    ...
    }).on("click","#addAudio",function(){


            var fileNameElement=$(".upload-file-name");
            var fileLanguageElement=$(".file-language");
        ...
        formData.append("lanaguage",fileLanguage);
        ...
        ajaxData('/a_dMin/add-sample-audio',formData,function(response){
            if(response.success)
            {
                messageDisplay("added successfuly");
                setTimeout(function(){
                    window.location.href=BASE_URL+"/a_dMin/samples";
                },2000);
