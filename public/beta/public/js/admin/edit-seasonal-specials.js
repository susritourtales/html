$(document).ready(function(){
    ...
    $("body").on("click","#updateSeason",function(){
       ...
       /* if(mediaFiles.length==0)
        ...
        var seasonalId=$("#seasonal_id").val();
        ...
        formData.append("seasonal_id",seasonalId);
        ...
        ajaxData('/a_dMin/edit-seasonal-special',formData,function(response){
            if(response.success)
            {
