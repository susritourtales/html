...
$(document).ready(function () {
        ...
        if(items>10) {
            $('.pagination').pagination({
                ...
                onPageClick: function (pageNumber) {
                    postData("/admin/admin/load-promoters-payments", {
    ...
    $("body").on("click",".pay",function () {
        ...
        var tref = $('#tbtref').val();
        postData("/admin/admin/pay-promoter", {id:id, amt: amount, tr:tref},function (response){
    ...
    function filterData()
    {
        ...
        ajaxCall=  $.ajax({
            type: "POST",
            url: BASE_URL+'/admin/admin/load-promoters-payments',
            data: formData,
            cache: false,
            contentType: false,
            processData: false,
