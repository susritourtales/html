     ...
     public function cityTourBookingAction()
     {
         ...
         if($saveBooking['success'])
         {
             ...
             if($discountPrice!=0) {
                 ...
                 $paymentRequest = $this->paymentTable()->addPayment(array('payment_request_id' => $response['id'], 'payment_response_id' => '', 'booking_id' => $bookingId, 'status' => \Admin\Model\Payments::payment_in_process));
